# AI Summit Budapest 2026 — esemény-előkészítés

> Az első valódi `schedule-guardian` futás. Készült: 2026-09-07 00:50.
> **Minden lenti tény forrás-megjelöléssel.** Amit nem tudok, az ❓-vel van jelölve —
> ⛔ nem találgatom (`core-no-guessing`).

---

## 🔴 A LEGFONTOSABB KORREKCIÓ

**A helyszín NEM a Tas vezér utca** — az a te otthonod (a kiindulópont).
A rendezvény a **Városligetben** van.

| | |
|---|---|
| **Mikor** | **2026. szeptember 7–8.** (hétfő–kedd) → ⚠️ **a nap 1 MA VAN** |
| **Fő helyszín** | **Magyar Zene Háza** — 1146 Budapest, **Olof Palme sétány 3.** |
| További helyszínek | **Néprajzi Múzeum** + szabadtéri „AI Summit Campus" zónák, Városliget |
| **Első előadás** | **09:00** — nyitó keynote *(Minister of Science and Technology: „Heaven or Apocalypse? What Will AI Bring Us?")* |
| Legkorábbi sáv | **08:50** — „AI Trends I" *(MBH Bank Visionary Stage, Magyar Zene Háza)*, 08:50–11:20 |
| Regisztráció nyitása | ❓ **a hivatalos oldal nem írja** — a te „8-tól kezdődik" infód valószínűleg ez |

---

## 🚇 Odajutás — Tas vezér u. 17 → Magyar Zene Háza

> ⚠️ **Az útvonal a BKK hálózati képéből származik, NEM élő útvonaltervezőből.**
> Nincs még eszközünk menetrend-lekérdezésre → `open-questions.md` **I-4**.
> ⇒ **A menetidő BECSLÉS**, nem mérés.

**Javasolt útvonal (a legkevesebb bizonytalansággal):**

```
🚶 Tas vezér u. 17  →  Móricz Zsigmond körtér          ~5–8 perc
🚋 4-es / 6-os villamos  →  Oktogon                     ~12 perc   (sűrűn jár, éjjel-nappal)
🚇 M1 (kisföldalatti)  →  Hősök tere VAGY Széchenyi fürdő  ~5 perc
🚶 séta a Magyar Zene Házához                            ~5–8 perc
                                                        ─────────
                                                  ≈ 35–45 perc
```

**Alternatíva (metró-súlyos):** M4 Móricz Zsigmond körtér → Kálvin tér → M3 → Deák Ferenc tér
→ M1 → Hősök tere. Több átszállás, hasonló idő.

📍 **Tájékozódás a helyszínen:** Hősök terétől **5 perc séta**; a **70-es troli** „Olof Palme
sétány" megállója a legközelebbi; a 74-es (Ajtósi Dürer sor) és a 75-ös (Zichy Géza utca) is jó.
A legközelebbi metró **Széchenyi fürdő (M1)**, onnan ~8 perc séta.

---

## ⏰ Mikor kelj — a te adataiddal számolva

**Bemenet:** készülődés **0,5–1 óra** *(user: „Fél kötőjel egy óra, amire elkészülök, attól
függ, hogy mennyire kapkodok")* · odajutás **≈45 perc** *(becslés, felső érték)*.

| Ha ott akarsz lenni… | Indulás | Készülődés kezdete |
|---|---|---|
| **08:30** *(kényelmesen, a 08:50-es sáv előtt)* | **07:45** | **06:45** *(nyugodtan)* / 07:15 *(kapkodva)* |
| **08:00** *(a te „8-tól" infód szerint)* | **07:15** | **06:15** / 06:45 |
| **08:50** *(épp az első sávra)* | 08:05 | 07:05 / 07:35 |

⚠️ **Most 00:50 van.** A 06:45-ös kelés **~5,5 óra alvás** — a te 8 órás ciklusodhoz képest
kevés (`sleep-system.md`). Ha a nyitó keynote (09:00) az igazi cél, a **08:30-as érkezés**
elég, és akkor **06:45** a kelés.

---

## 👔 Öltözködés

> **Te:** *„Mi volt valami »casual business«? Business casual be kell lenni? Ilyet láttam
> valahol. De… Majd ezt eszembe juttathatod extrának."*

| | |
|---|---|
| **A hivatalos oldalon** | ❓ **NINCS dress code** *(sem a főoldalon, sem a programnál)* |
| **Assistant-következtetés** ⚠️ | Üzleti AI-konferencián a **smart casual / business casual** a bevett — gallér, rendes cipő, zakó opcionális. **DE ez nem mért tény**, csak a rendezvény-típusból következik. |

📌 Ha valahol konkrétan „business casual"-t láttál, **az a mérvadó**, nem az én
következtetésem — az valószínűleg a jegyvásárláskor kapott levélben / az event appban van.

---

## 🎒 Mit vigyél

*(A `current/inventory/personal-items.md`-ből, a te felsorolásod alapján.)*

**Alap:** 📱 telefon · 👛 tárca · 🎫 jegy/bérlet · 👓 szemüveg · 🔑 kulcs

**Erre az eseményre:** 🎧 füles · ⌚ okosóra · 💧 víz

**Assistant-javaslat ⚠️ (megerősítendő):** 🔋 powerbank *(egész napos rendezvény, az event app
és a telefon meríti)* · 💳 névjegy, ha van *(„networking zones" van a programban)*

> 📌 A jegy **foodtruck-kupont** is tartalmaz — ebéddel nem kell külön számolni.
...
## ❓ Amit nem tudok — ezek nélkül a fenti számok becslések

| # | Kérdés | Hatás |
|---|---|---|
| 1 | **Melyik napra szól a jegyed?** 7-re, 8-ra, vagy mindkettőre? *(a standard jegy mindkét napra szól)* | ez dönti el, hogy MA kell-e menned |
| 2 | **Tényleg 8:00 a kezdés?** A program első eleme 08:50/09:00 | 45-50 perc alvás múlik rajta |
| 3 | Mennyi **ráhagyást** akarsz? | `open-questions.md` I-2 |
| 4 | Van-e **útvonaltervező eszközünk**? *(nem fizetős)* | I-4 — enélkül a menetidő becslés marad |

---

## Források

- [AI Summit Budapest 2026 — hivatalos oldal](https://www.aisummit.hu/en)
- [AI Summit 2026 — Programme](https://www.aisummit.hu/en/program)
