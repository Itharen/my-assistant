...
| T-77 | 🙋 | 🔊 **Kell-e külön hang az ÉSZLELÉSRE?** | A `typing` hang átkerült a **feldolgozás** kezdetére *(owner-kérés, 2026-09-10)*. ⇒ Az **észlelésnek** *(„elkezdtél beszélni")* jelenleg **nincs saját hangja**. ⚠️ Az owner korábban **négy** pillanatot nevezett meg: *„amikor elindul az érzékelés, meg amikor elküldöd feldolgozásra, meg amikor eldobtuk… meg amikor feldolgozzuk"* ⇒ az elsőre **nincs hangunk** | 🙋 **owner-döntés:** kell-e rá jelzés, és ha igen, **melyik** CCAP-hang. ⛔ Nem találgatok — az ő hangkészlete, az ő jelentései |
