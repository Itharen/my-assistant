...
**Utoljára frissítve:** 2026-09-07 15:50
...
| T-22 | 🤖 | 🔴 **Voice control ÁTEMELÉSE a régi CCAP-ból** *(nagy)* — **ELŐREVÉVE** | **4/5 szakasz**: mind a **70 fájl** bent, 2 fájl kivételével fordul. Terv: `__agent/plans/voice-control-transplant/hyperplan.plan.md` | ✅ a `BodyInit`-ütközés **oka feltárva**: TS 5.5 → 5.9 *(nem blokkol — a `tsc` emittál, a minta futásidőben igazolt)*. ⇒ **5. szakasz**: bekötés + kétirányú tükör-szöveg + élő próba |
