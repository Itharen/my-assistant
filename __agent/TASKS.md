...
| T-22 | 🤝 | 🔊 **Voice control — mind a 3 owner-követelmény MEGÉPÍTVE** | ⭐ **2026-09-07 23:05:** (1) `voice-drop-probe.ts` — a néma eldobás **MÁSODPERCBEN** mérhető; (2) `voice-missed-speech.ts` — ami nem jutott át, az is **látszik** a hang-csatornában, összevonva; (3) `voice-cues.ts` — 🔊 **hangjelzések a CCAP EREDETI hangjaival**, futásidőben igazolva. CLI **575/575** zöld | ⏳ **ÉLŐ MÉRÉSRE VÁR:** az átviteli arány csak akkor derül ki, ha az owner beszél. ❓ Q-07 (hang-hozzárendelés) · Q-08 (fejhallgató-e) |
