...
| T-22 | 🤝 | 🔊 **Voice control — a DEV dolgozik rajta** | ⭐ **2026-09-07 22:44: 1. követelmény (MÉRÉS) MEGÉPÍTVE** — `voice-drop-probe.ts`: a WAV-életciklus figyelése kívülről megmondja, hány **MÁSODPERC** hang veszett el némán, és elválasztja az összeolvadt megszólalást a valódi veszteségtől. CLI 550/550 zöld. ⏳ Élő adat az owner beszédére vár | ⏸️ **a dev dolgozik rajta.** Következő: 2. (minden átirat a hang-csatornába) → 3. (hangjelzések) |
