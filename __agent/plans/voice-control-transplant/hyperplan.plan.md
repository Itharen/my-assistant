...
| **Teszt** | CLI **635/635** zöld + szerver **82/82** — unit + 🧭 3 user-journey, **pozitív kontrollal** igazolva; fő `tsc` zöld; a transzplantált build emittál |
