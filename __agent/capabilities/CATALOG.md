...
| C-48 | **Átvételi nyugta** | ⏳ **megépült — jóváhagyásra vár** (2026-09-07) | Ha a köteg 90 mp-nél tovább vár, egy rövid sor jelzi, hogy az üzenetek **megérkeztek** — így nem kell megkérdezned. ⛔ Kötegenként egyszer; ⛔ NEM számít válasznak | `cli/src/discord/discord.receipt.ts` |
