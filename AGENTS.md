...
| `current/principles/dev-session-supervision.md` | 👁️ **Rá kell néznem a DEV-re** — a bejegyzés nem bizonyíték a haladásra. Négy mérés: él-e a session · van-e életjel · van-e commit · **mozdult-e a KÉRT kód**. Mérve: 3,5 óra csend úgy, hogy sehol nem látszott |
